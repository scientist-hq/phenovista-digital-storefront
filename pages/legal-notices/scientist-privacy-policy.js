...
const ScientistPrivacyPolicy = () => (
  <div className='container'>
    <TitledTextBox title='Scientist.com Global Privacy Policy' text={text} />
  </div>
)


export default ScientistPrivacyPolicy
...
This Global Privacy Policy explains what data we collect, how it is collected, why we use the data we collect, when and with who we may share your personal data and the rights and choices you have in relation to your personal data.

This Global Privacy Policy applies where Scientist.com receives personal data through our interactions with you when we conduct our business. This interaction may be through our various web presences1 (our "Websites") other communication channels including email, social media, through your interaction with the services, features and content we offer through our ecommerce custom research and development platform (the "Platform") and any other platform with which we collaborate on a white label basis ("Collaborators"), when you attend one of our events, where you share data directly with us or, subject to appropriate permissions, where your data has been provided by a third party authorized to share such data with us.

This Global Privacy Policy does not apply to any third-party websites, services or applications, even if they are accessible through our Websites and/or Platform or if our Websites and/or Platform is accessed through them.

For the purposes of this Global Privacy Policy, the personal data Scientist.com processes relates to the people we interact with, including customers, partners, clients, suppliers, vendors (or in each case the individuals representing those companies, organizations or entities) or any other person we interact with. This policy therefore does not apply to information relating to corporations, organizations or entities. This is because Data Protection Laws only apply to information relating to natural persons. Information relating to corporate bodies may still be protected by other laws such as confidentiality and we take those obligations seriously as well.
...
If you have any questions, concerns or complaints about this Global Privacy Policy or about how your personal data is handled, please contact us through the email address or postal address stated below:

Email: privacy@scientist.com Post: FAO Privacy Dept Scientist.com 329 S Highway 101 Suite 230 Solana Beach, CA 92075
...
2. Information we collect
    ...
    Google Analytics: We collect data through using Google Analytics a web analytics service provided by Google, Inc. (‘Google'), to learn about your journey on our Websites and Platform and build better services. Google Analytics uses cookies (text files placed on your computer) to help us analyse how users use the site. The information generated by the cookie about your use of our Websites and Platform (including your IP address) will be transmitted to and stored by Google on servers in the United States. Google will use this information for the purpose of evaluating your use of our Websites and Platform, compiling reports on Website and Platform activity for us and other website operators and providing other services relating to Website and Platform activity and internet usage. Google may also transfer this information to third parties where required to do so by law, or where such third parties process the information on Google's behalf. Where you have clicked I accept on the cookie pop up notice, you will have given your consent to the processing of data about you by Google in the manner and for the purposes set out above. Further information is also available in Google Analytics' Privacy Policy which is available here: https://support.google.com/analytics/answer/6004245?hl=en and https://policies.google.com/privacy?hl=en
    Images We may produce videos or photographs which include the names or images of the employees or representatives of our customers, partners, clients, suppliers, vendors and/or other individuals with whom we interact ("Images") for promotional purposes for both your own company, organization or representative entity and/or Scientist.com. Together with the image with we may collect contact details of the people in the Images. This personal data will be used and stored by us in accordance with this Global Privacy Policy and the waiver letter that you and, where applicable, the legal entity you represent signs to give us permission to use the respective Images. We will not publish any such Image unless and until a valid and binding waiver letter has been executed by the relevant parties authorising us to do so. Once the Images are published they will be in the public domain, Scientist.com will only have control over Images that Scientist.com publishes directly, and not over any copies made by third parties. We only collect and process personal data for this purpose if you give us consent. You may withdraw consent through emailing: privacy@scientist.com.
...
Please note: You must not put any personal data revealing racial or ethnic origin, political opinions, religious or philosophical beliefs, or trade union membership, and the processing of genetic data, biometric data for the purpose of uniquely identifying a natural person, data concerning health or data concerning a natural person's sex life or sexual orientation (including without limitation, any patient data or donor information etc.) ("Special Categories of Personal Data") or any information relating to criminal convictions or offences on the Platform or via our Websites or within any communications shared with us, or include this within any attachments submitted on the Website and/or Platform and by the terms of this Global Privacy Policy you will be deemed to instruct us to remove any such Special Categories of Personal Data or any information relating to criminal convictions or offences from the Platform, although we do not have any obligations to you to check for this or to do so.
...
We do not share or sell to other organizations for commercial purposes any personally identifiable data, except to provide services you have requested, when we have your permission, or as otherwise set forth in this Global Privacy Policy. Please see the relevant cookies policy for further information about what information may be automatically collected when you visit that Website.
...
As a global organization, we may share your information with other Scientist.com group companies where required to provide you with the services, or to enable us to give you access to the Websites and the Platform or otherwise to fulfil the purposes set out in this this Global Privacy Policy.

We may also share your personal data in the following circumstances:

    Except as set forth in this Global Privacy Policy, Scientist.com does not determine the purposes and means of processing any personal data placed on or shared via the Websites and/or Platform by our customers, partners, clients, suppliers, vendors, (or in each case the individuals representing those companies, organizations or entities) between themselves. Such parties may decide to share personal information between themselves and with other parties (including Collaborators) via the Websites and/or Platform. Such parties are solely responsible for ensuring that any transfers of personal data between them are made in accordance with the applicable Data Protection Laws. We work and enable customers, partners, clients, suppliers, vendors to work together, to discuss and agree any applicable data protection terms which may be required between such parties, in relation to the sharing of such personal data. For the transaction in question to take place, we may share information relating to it with the relevant Client and Supplier.
    We transfer information required to order and invoice for services bought and sold via the Platform ("Service Data") to Collaborators as a processor where a Client's request for Services from a supplier/ vendor originates through a portal operated by us but marketed and made accessible to the customer/client by a Collaborator. Scientist.com transfers such Service Data to enable that Collaborator and Scientist.com to work together to market that portal, make it available to customers, partners, clients, suppliers, vendors and for that Collaborator to help facilitate transactions between customers, partners, clients, suppliers, vendors on the Platform. In relation to such customer/client requests, the Collaborator has the same access to the portal and the Platform and all information on it as Scientist.com, including information you enter on it and all correspondence between customers, partners, clients, suppliers and vendors. The Collaborator may only use such information: (i) in relation to customers/clients, in accordance with the terms of use of the portal in question, and (ii) in relation to suppliers/vendors, in accordance with the letter from the Collaborator you may receive with every request from a customer/client which originates from the portal in question (the "Supplier Letter"). The Collaborator shall keep such information confidential in accordance with the terms of use of the portal in question and the Supplier Letter. If you are a supplier/vendor and do not accept the terms of the Supplier Letter, please do not respond to any request from a customer/client originating from the portal in question;
...
These third-party service providers (and others that we may engage in the future) may have access to personal information for the purposes of performing services on our behalf. These service providers shall not use such personal data for any other purposes, as governed more specifically by the terms of their agreements with us.
    ...
    Protection of Scientist.com, our group and others: We may disclose personal data when we believe disclosure is appropriate to comply with the law or an investigation into illegal activity; to enforce our agreements; or to protect the rights, property, or safety of Scientist.com, our group, our customers, partners, clients, suppliers, vendors, or others. It is necessary to share information in order to investigate, prevent, or act regarding illegal activities, suspected fraud, situations involving potential threats to the physical safety of any person, violations of Terms of Service, or as otherwise required by law. This includes exchanging information with other companies and organizations for fraud protection and credit risk reduction. This does not include selling, renting, sharing, or otherwise disclosing personal data from you for commercial purposes in violation of the conditions set forth in this Global Privacy Policy.
...
You can direct any questions or complaints to us about the use or disclosure of personal data that relates to you by sending an email to us at privacy@scientist.com, or in writing to the address below (Our Global contact address).
...
If you are in the EEA, you can contact the Scientist EU Representative at privacy@scientist.com.
...
If a complaint or dispute cannot be resolved through our internal process, we agree to dispute resolution using BBB online as a third-party resolution provider (https://www.bbb.org/consumer-complaints/file-a-complaint/). If you have any questions, concerns or complaints about this Global Privacy Policy or about how your personal data is handled, please contact us through our website, or at privacy@scientist.com or write to us at:

Legal Department Scientist.com 329 S Highway 101 Suite 230, Solana Beach, CA 92075
CHANGES TO THIS GLOBAL PRIVACY POLICY

Please note that this Global Privacy Policy may change from time to time. We expect most changes to be minor. Regardless, we will post any policy changes on our website and, if the changes are significant, we will provide a more prominent notice (including, for certain services, email notification of changes). We may email periodic reminders of our notices and conditions, unless you have instructed us not to, but you should check our website frequently to review recent changes. Unless stated otherwise, our current Global Privacy Policy applies to all information that we have about you and your account. Each version of this Global Privacy Policy will be identified at the top of the page by its effective date.

The date of the last update will appear at the top of this Global Privacy Policy.

1 scientist.com, healtheconomics.com, insidescientific.com, biopharmcatalyst.com, contractresearchmap.com, hykuup.com, trialinsights.com, and all subdomains thereof.
`
